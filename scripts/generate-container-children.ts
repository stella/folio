...
const DISPATCHED_CONTAINERS: readonly (readonly [
  ...
  [
    ...
    // bidirectional wrapper, a smart tag, a run-level custom-XML wrapper and
    // an inline content control: they share
    // `EG_PContent`/`EG_ContentRunContent` and folio reads them with one
