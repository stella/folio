    ...
    <div class="ipd-dialog__body">
      ...
      <fieldset class="ipd-fieldset">
        ...
        <div class="ipd-row">
          ...
          <label class="ipd-label" style="width: 60px">{{
...
watch(
  ...
  (open) => {
    ...
    if (d?.horizontal?.align) {
      hMode.value = "align";
      hAlign.value = d.horizontal.align;
    } else if (d?.horizontal?.posOffset != null) {
      hMode.value = "offset";
      hOffset.value = d.horizontal.posOffset;
    }
    hRelativeTo.value = d?.horizontal?.relativeTo ?? "column";
    if (d?.vertical?.align) {
      vMode.value = "align";
      vAlign.value = d.vertical.align;
    } else if (d?.vertical?.posOffset != null) {
      vMode.value = "offset";
      vOffset.value = d.vertical.posOffset;
    }
