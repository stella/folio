<!--
  Vue port of packages/react/src/components/ui/TableStyleGallery.tsx —
  preset gallery whose data + preview rendering live in the shared
  `../tableStylePresets` module (also consumed by InsertTableDialog).
-->
<template>
  <div class="tsg">
    <div class="tsg__grid">
