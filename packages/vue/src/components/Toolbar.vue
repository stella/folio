  ...
  <div class="basic-toolbar" v-if="view">
    ...
    <div class="toolbar-dropdown" ref="styleDropdownRef">
      ...
      >
        ...
        >
          <!-- Spread into a fresh literal so it gets the implicit CSS-var index
               signature Vue's CSSProperties expects (a named interface lacks it). -->
    ...
    <div class="toolbar-dropdown" ref="alignDropdownRef">
      ...
      >
        <button
          ...
          :title="`${t('alignLeft')} (${t('alignment.alignLeftShortcut')})`"
          @mousedown.prevent="
        ...
        <button
          ...
          :title="`${t('alignCenter')} (${t('alignment.centerShortcut')})`"
          @mousedown.prevent="
        ...
        <button
          ...
          :title="`${t('alignRight')} (${t('alignment.alignRightShortcut')})`"
          @mousedown.prevent="
        ...
        <button
          ...
          :title="`${t('justify')} (${t('alignment.justifyShortcut')})`"
          @mousedown.prevent="
    ...
    <EditingModeDropdown
      ...
      @update:model-value="(m: EditorMode) => $emit('mode-change', m)"
    />
 ...
 * command needs, it returns a ProseMirror `Command`. Heterogeneous across
 * commands, so it is typed structurally rather than per-command.
 */
