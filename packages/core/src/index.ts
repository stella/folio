...
export {
  ...
  type FolioContentMove,
  type FolioContentParagraphFormattingChange,
  ...
  type FolioContentStructuralEvent,
  type FolioContentTableReplacement,
  type FolioContentTextSegment,
  type FolioContentValuePresence,
...
export {
  ...
  type CompareResult,
  type CompareTableCellCoordinate,
  type CompareTableCellFormattingPropertyChange,
  type CompareTableCellFormattingPropertyName,
  type CompareTableCoordinate,
  type CompareTableFormatChange,
  type CompareTableFormatDetails,
  type CompareTableFormattingPropertyChange,
  type CompareTableFormattingPropertyName,
  type CompareTableRowCoordinate,
  type CompareTableRowFormattingPropertyChange,
...
export {
  ...
  type FolioAIInlineFormattingPatch,
  type FolioAIParagraphSpacing,
