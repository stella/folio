...
export const writePdf = async (
...
): Promise<Result<WritePdfResult, WritePdfError>> => {
  ...
  // The one place the artifact is resolved for painting, and only once a run
  // that needs it has actually been found.
