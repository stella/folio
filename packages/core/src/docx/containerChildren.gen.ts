...
export const CONTAINER_CHILDREN = {
  ...
  "w:fonts": ["font"],
  "w:font": ["altName", "charset", "embedBold", "embedBoldItalic", "embedItalic", "embedRegular", "family", "notTrueType", "panose1", "pitch", "sig"],
  "w:numbering": ["abstractNum", "num", "numIdMacAtCleanup", "numPicBullet"],
  "w:abstractNum": ["lvl", "multiLevelType", "name", "nsid", "numStyleLink", "styleLink", "tmpl"],
  "w:lvl": ["isLgl", "legacy", "lvlJc", "lvlPicBulletId", "lvlRestart", "lvlText", "numFmt", "pPr", "pStyle", "rPr", "start", "suff"],
  "w:num": ["abstractNumId", "lvlOverride"],
  "w:lvlOverride": ["lvl", "startOverride"],
