...
- [#866](https://github.com/stella/folio/pull/866) [`c0e1b75`](https://github.com/stella/folio/commit/c0e1b75de80787791d4119f170fdbf2d54593672) Thanks [@jan-kubica](https://github.com/jan-kubica)! - The outline sidebar collects headings using the document's style table, so a localized heading style id such as `Nadpis1` or `berschrift2` still lists.
